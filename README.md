# Run Cucumber TestNG SmartUI Tests with HyperExecute on TestMu AI (Formerly LambdaTest)
...
```bash
git clone https://github.com/LambdaTest/cucumber-testNG-smartui-hyperexecute-sample && cd cucumber-testNG-smartui-hyperexecute-sample
...
```bash
hyperexecute.exe --config hyperexecute.yaml --force-clean-artifacts
```
